...
class __TwigTemplate_77136cf50fabb95459bd05f10ea9f37ddf241c4ae28d2d9fcfac688a9cb6f576 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Create");
  ...
  ";
        // line 43
        if ((0 !== CoreExtension::compare(($context["db"] ?? null), "mysql"))) {
            // line 44
...
yield _gettext("Collation");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["collation"]) {
                ...
                yield "\"";
                yield (((0 === CoreExtension::compare(($context["db_collation"] ?? null), CoreExtension::getAttribute($this->env, $this->source, $context["collation"], "getName", [], "method", false, false, false, 204)))) ? (" selected") : (""));
                yield ">
                      ";
                // line 205
...
";
    ...
    {
        return new Source("", "database/operations/index.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\database\\operations\\index.twig");
    }
}
