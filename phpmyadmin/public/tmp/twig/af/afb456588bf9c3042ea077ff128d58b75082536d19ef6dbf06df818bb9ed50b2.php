...
class __TwigTemplate_25e6289db25cafdc74675cb8f2bc0fe2e6450cb177afc8495b3b14c6a5955ed4 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Constraint properties");
            ...
            yield "</th>
                    ";
            // line 16
            if ((0 === CoreExtension::compare(Twig\Extension\CoreExtension::upper($this->env->getCharset(), ($context["tbl_storage_engine"] ?? null)), "INNODB"))) {
                // line 17
                yield "                        <th>
                            ";
...
yield _gettext("+ Add constraint");
    ...
    ";
        ...
        if ( !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["relation_parameters"] ?? null), "relationFeature", [], "any", false, false, false, 102))) {
            // line 103
            yield "        ";
            if (((0 !== CoreExtension::compare(($context["default_sliders_state"] ?? null), "disabled")) && PhpMyAdmin\Utils\ForeignKey::isSupported(($context["tbl_storage_engine"] ?? null)))) {
                // line 104
...
yield _gettext("Choose column to display:");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                yield "\"";
                // line 213
                if ((array_key_exists("disp", $context) && (0 === CoreExtension::compare((($__internal_compile_14 = $context["row"]) && is_array($__internal_compile_14) || $__internal_compile_14 instanceof ArrayAccess ? ($__internal_compile_14["Field"] ?? null) : null), ($context["disp"] ?? null))))) {
                    // line 214
...
";
    ...
    {
        return new Source("", "table/relation/common_form.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\table\\relation\\common_form.twig");
    }
}
