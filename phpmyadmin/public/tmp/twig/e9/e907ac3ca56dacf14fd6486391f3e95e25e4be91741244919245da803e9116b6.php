...
/* indexes.twig */
class __TwigTemplate_16a5a935fe626884410175956dea9a13d538a21c1723c4cdbf9a409f562a1da5 extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            ";
              ...
              <td rowspan=\"";
                ...
                ";
                // line 43
                if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["index"], "getName", [], "method", false, false, false, 43), "PRIMARY"))) {
                    // line 44
                    yield "                  ";
...
($context["url_params"] ?? null), ($context["index_params"] ?? null)), PhpMyAdmin\Html\Generator::getIcon("b_drop", _gettext("Drop")), ["class" => "drop_primary_key_index_anchor ajax"]);
              ...
              ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                    // line 69
                    yield "                ";
                    if ((1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 69), 1))) {
                        // line 70
                        yield "                  <tr class=\"noclick\">
                ";
                    }
                ...
                ";
                    // line 82
                    if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 82), 1))) {
                        // line 83
                        yield "                  <td rowspan=\"";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["columns_count"] ?? null), "html", null, true);
                        yield "\">";
...
";
    ...
    {
        return new Source("", "indexes.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\indexes.twig");
    }
}
