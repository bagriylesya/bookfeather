...
class __TwigTemplate_5bef71efa512183e51552ec1e598aae749c698b9054ff43d9f1cc4a130790a9e extends Template
{
    private $source;
    private $macros = [];
    ...
    <table id=\"";
        ...
        style=\"position:absolute; ";
            // line 18
            yield (((0 === CoreExtension::compare(($context["text_dir"] ?? null), "rtl"))) ? ("right") : ("left"));
            yield ":";
            // line 19
            ...
            yield "px; display:";
            // line 21
            yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["tab_pos"] ?? null), ($context["t_n"] ?? null), [], "array", true, true, false, 21) || (0 === CoreExtension::compare(($context["display_page"] ?? null),  -1)))) ? ("block") : ("none"));
            yield "; z-index: 1;\"> <!--\"-->
        <thead>
            <tr class=\"header\">
                ";
...
";
    ...
    {
        return new Source("", "database/designer/database_tables.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\database\\designer\\database_tables.twig");
    }
}
