...
class __TwigTemplate_8d7b1e5f0494346a90474d9254d29f0b47ed2295685999d65eebda7a57a8d362 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <span id=\"page_name\">
            ";
            // line 10
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((((0 === CoreExtension::compare(($context["selected_page"] ?? null), null))) ? (_gettext("Untitled")) : (($context["selected_page"] ?? null))), "html", null, true);
            yield "
        </span>
        <span id=\"saved_state\">
            ";
            // line 13
            yield (((0 === CoreExtension::compare(($context["selected_page"] ?? null), null))) ? ("*") : (""));
            yield "
        </span>
    </div>
";
...
";
    ...
    {
        return new Source("", "database/designer/main.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\database\\designer\\main.twig");
    }
}
