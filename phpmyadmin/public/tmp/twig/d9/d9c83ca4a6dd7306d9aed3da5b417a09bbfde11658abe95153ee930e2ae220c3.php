...
class __TwigTemplate_78a4430c787c6cafa22005223b0190ed688913217e940c6c38e9315efd59667c extends Template
{
    private $source;
    private $macros = [];
    ...
    <li class=\"nav-item\">
      <a href=\"";
            ...
            yield (((0 === CoreExtension::compare(($context["route"] ?? null), "/table/structure"))) ? (" active") : (""));
            yield " disableAjax\">
        ";
            // line 5
    ...
    <li class=\"nav-item\">
      <a href=\"";
            ...
            yield (((0 === CoreExtension::compare(($context["route"] ?? null), "/table/relation"))) ? (" active") : (""));
            yield " disableAjax\">
        ";
            // line 11
...
";
    ...
    {
        return new Source("", "table/page_with_secondary_tabs.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\table\\page_with_secondary_tabs.twig");
    }
}
