...
class __TwigTemplate_64e7c05a894ef755820533e7bb6846027d04dd71dc46c205b5a59458e3df134d extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Effective");
            ...
            yield "
                ";
            // line 43
            if ((array_key_exists("tot_size", $context) && (0 === CoreExtension::compare(($context["mergetable"] ?? null), false)))) {
                // line 44
                yield "                    <tr>
                        <th class=\"name\">";
yield _gettext("Total");
            ...
            // line 53
            yield "                ";
            if (((array_key_exists("free_size", $context) && ((((0 === CoreExtension::compare(            // line 54
($context["tbl_storage_engine"] ?? null), "MYISAM")) || (0 === CoreExtension::compare(            // line 55
($context["tbl_storage_engine"] ?? null), "ARIA"))) || (0 === CoreExtension::compare(            // line 56
($context["tbl_storage_engine"] ?? null), "MARIA"))) || (0 === CoreExtension::compare(            // line 57
($context["tbl_storage_engine"] ?? null), "BDB")))) || ((0 === CoreExtension::compare(            // line 58
($context["tbl_storage_engine"] ?? null), "INNODB")) && (0 === CoreExtension::compare(($context["innodb_file_per_table"] ?? null), true))))) {
                // line 59
                yield "                <tfoot>
...
yield _gettext("Format");
            ...
            yield "</th>
                    ";
            // line 85
            if ((0 === CoreExtension::compare((($__internal_compile_2 = ($context["showtable"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["Row_format"] ?? null) : null), "Fixed"))) {
                // line 86
                yield "                        <td class=\"value\">";
yield _gettext("static");
                yield "</td>
                    ";
            } elseif ((0 === CoreExtension::compare((($__internal_compile_3 =             // line 87
...
yield _gettext("Options");
            ...
            yield "</th>
                    ";
            // line 98
            if ((0 === CoreExtension::compare((($__internal_compile_6 = ($context["showtable"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["Create_options"] ?? null) : null), "partitioned"))) {
                // line 99
                yield "                        <td class=\"value\">";
...
($context["showtable"] ?? null), "Avg_row_length", [], "array", true, true, false, 125)) && (1 === CoreExtension::compare((($__internal_compile_9 =         // line 126
...
($context["showtable"] ?? null), "Rows", [], "array", true, true, false, 136)) && (1 === CoreExtension::compare((($__internal_compile_13 =         // line 137
($context["showtable"] ?? null)) && is_array($__internal_compile_13) || $__internal_compile_13 instanceof ArrayAccess ? ($__internal_compile_13["Rows"] ?? null) : null), 0))) && (0 === CoreExtension::compare(        // line 138
...
";
    ...
    {
        return new Source("", "table/structure/display_table_stats.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\table\\structure\\display_table_stats.twig");
    }
}
