...
class __TwigTemplate_b04225878bd8f3eacb8ad59606d40e54e9ca05260b0ec48895f4137a1114f386 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        if ((array_key_exists("submit_attribute", $context) && (0 !== CoreExtension::compare(($context["submit_attribute"] ?? null), false)))) {
            // line 2
            yield "    ";
...
($context["extracted_columnspec"] ?? null), "attribute", [], "array", true, true, false, 7)) {
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            yield "\"";
            // line 18
            yield (((0 === CoreExtension::compare(($context["attribute"] ?? null), Twig\Extension\CoreExtension::upper($this->env->getCharset(), (($__internal_compile_4 = ($context["attribute_types"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[$context["i"]] ?? null) : null))))) ? (" selected=\"selected\"") : (""));
            yield ">
            ";
            // line 19
...
";
    ...
    {
        return new Source("", "columns_definitions/column_attribute.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\columns_definitions\\column_attribute.twig");
    }
}
