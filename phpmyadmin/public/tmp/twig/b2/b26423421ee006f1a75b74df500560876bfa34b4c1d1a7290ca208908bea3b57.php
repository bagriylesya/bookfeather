...
class __TwigTemplate_df82f322d05a63ab3e60ec0296c63959c9eab97ee216a0c4691f82bb89b84f4d extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Connection:");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["collation"]) {
                    ...
                    yield "\"";
                    // line 103
                    yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["collation"], "name", [], "any", false, false, false, 103), ($context["tbl_collation"] ?? null)))) ? (" selected") : (""));
                    yield ">";
                    // line 104
...
yield _gettext("Storage engine");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["engine"]) {
                ...
                // line 116
                yield ((((0 === CoreExtension::compare(Twig\Extension\CoreExtension::lower($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["engine"], "name", [], "any", false, false, false, 116)), Twig\Extension\CoreExtension::lower($this->env->getCharset(), ($context["tbl_storage_engine"] ?? null)))) || (Twig\Extension\CoreExtension::testEmpty(($context["tbl_storage_engine"] ?? null)) && CoreExtension::getAttribute($this->env, $this->source, $context["engine"], "is_default", [], "any", false, false, false, 116)))) ? (" selected") : (""));
                yield ">";
                // line 117
...
";
    ...
    {
        return new Source("", "columns_definitions/column_definitions_form.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\columns_definitions\\column_definitions_form.twig");
    }
}
