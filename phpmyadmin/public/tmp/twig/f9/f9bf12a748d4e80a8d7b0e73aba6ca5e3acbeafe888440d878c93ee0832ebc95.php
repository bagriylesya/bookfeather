...
class __TwigTemplate_3a9596e094cd4cb6b591df0b0c3191fd7b32c8edce2a51873a9862cd76d0f984 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Action");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["partition"]) {
                ...
                if (($context["has_description"] ?? null)) {
                    ...
                    // line 51
                    yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["partition"], "getMethod", [], "method", false, false, false, 51), "LIST"))) ? (" IN (") : (" < "));
                    // line 52
                    ...
                    // line 53
                    yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["partition"], "getMethod", [], "method", false, false, false, 53), "LIST"))) ? (")") : (""));
                    // line 54
                    yield "</code>
                            </td>
                        ";
...
";
    ...
    {
        return new Source("", "table/structure/display_partitions.twig", "E:\\OSPanel\\home\\bookfeather.loc\\phpmyadmin\\public\\templates\\table\\structure\\display_partitions.twig");
    }
}
